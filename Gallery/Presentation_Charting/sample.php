...
<html>
  <head>
    ...
    <title>Row64 - Blended Color Theme Pie Chart</title>
  ...
  <body>
    ...
    <div class="frame">
      <div class="tcontainer">
        ...
        <font style="font-size:44px;">Blended Color Theme Pie Chart</font>
        </h1>
     ...
     <div class="frame">
     <img src="./images/sample.png" alt="" width="395px" height="233px">
     </div>

     <div class="frame">
      <div class="tcontainer"style="width:800px">
        <font style="font-size:20px;"><br>
        Example of pie chart using color theme.
        Row64 allows doing so and so...<br><br><br><br><br>
        Click Chart
        </font>
        <img src="./images/sample1.png" alt="" width="176px" height="156px">
        <font style="font-size:20px;">
            <br><br>
            Click Histogram
        </font>
        <img src="./images/sample2.png" alt="" width="129px" height="82px">
        <font style="font-size:20px;">
            <br><br>
            Opens Formula
        </font>
        <img src="./images/sample3.png" alt="" width="239px" height="92px">
        <font style="font-size:20px;">
            <br><br>
            Click Run
        </font>

  ...
  <body>
    ...
    <div class="frame">
      <div class="tcontainer">
        ...
        <font style="font-size:44px;">Blue Globe</font>
        </h1>
     ...
     <div class="frame">
     <img src="../images/Section_PR/HighRes/PC_BlueGlobe_H.jpg" alt="" width="1200px" height="690px">
     </div>

  ...
  <body style="font-family: 'AkkuratLLWeb-Regular';">
    ...
    <div class="frame">
      <div class="tcontainer">
        ...
        <font style="font-size:44px;">Cloropleth</font>
        </h1>
     ...
     <div class="frame">
     <img src="../images/Section_SC/HighRes/SC_Cloropath_H.jpg" alt="" width="1200px" height="690px">
     </div>

     <div class="frame">
      <div class="tcontainer"style="width:800px">
        <font style="font-size:20px;"><br>
        Here is an example of a Cloropleth in Row 64 and how to access it.<br><br><br><br><br>
        ...
        <font style="font-size:20px;">
            <br><br>
            Click on Cloropleth.<br>
        </font>
        <img src="./images/Cloropleth.png" alt="" width="252px" height="63px">
        <font style="font-size:20px;">
            <br><br>
            Click Run.<br>
        </font>

...
<html>
  <head>
    ...
    <title>Row64 - Stream Graph</title>
  ...
  <body style="font-family: 'AkkuratLLWeb-Regular';">
    ...
    <div class="frame">
      <div class="tcontainer">
        ...
        <font style="font-size:44px;">Stream Graph</font>
        </h1>
     ...
     <div class="frame">
     <img src="../images/Section_SC/HighRes/SC_Stream_H.jpg" alt="" width="1200px" height="690px">
     </div>

     <div class="frame">
      <div class="tcontainer"style="width:800px">
        <font style="font-size:20px;"><br>
        Here is an example of a Stream Graph in Row 64 and how to access it.<br><br><br><br><br>
        ...
        <font style="font-size:20px;">
            <br><br>
            Click on Stream Graph.<br>
        </font>
        <img src="./images/LinePlot.png" alt="" width="258px" height="228px">
        <font style="font-size:20px;">
            <br><br>
            Click Run.<br>
        </font>

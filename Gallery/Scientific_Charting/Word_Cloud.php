  ...
  <body style="font-family: 'AkkuratLLWeb-Regular';">
    ...
    <div class="frame">
      <div class="tcontainer">
        ...
        <font style="font-size:44px;">Word Cloud</font>
        </h1>
     ...
     <div class="frame">
     <img src="../images/Section_SC/HighRes/SC_Wordmap_H.jpg" alt="" width="1200px" height="690px">
     </div>

     <div class="frame">
      <div class="tcontainer"style="width:800px">
        <font style="font-size:20px;"><br>
        Here is an example of a Word Cloud in Row 64 and how to access it.<br><br><br><br><br>
        ...
        <font style="font-size:20px;">
            <br><br>
            Click on Word Cloud.<br>
        </font>
        <img src="./images/Wordmap.png" alt="" width="249px" height="90px">
        <font style="font-size:20px;">
            <br><br>
            Click Run.<br>
        </font>

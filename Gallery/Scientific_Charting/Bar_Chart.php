  ...
  <body style="font-family: 'AkkuratLLWeb-Regular';">
    ...
    <div class="frame">
      <div class="tcontainer">
        ...
        <font style="font-size:44px;">Bar Chart</font>
        </h1>
     ...
     <div class="frame">
     <img src="../images/Section_SC/HighRes/SC_Bar_H.jpg" alt="" width="1200px" height="690px">
     </div>

     <div class="frame">
      <div class="tcontainer"style="width:800px">
        <font style="font-size:20px;"><br>
        Here is an example of a Bar Chart in Row 64 and how to access it.<br><br><br><br><br>

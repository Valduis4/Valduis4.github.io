...
<html>
  <head>
    ...
    <title>Row64 - Horizontal Bar</title>
  ...
  <body style="font-family: 'AkkuratLLWeb-Regular';">
    ...
    <div class="frame">
      <div class="tcontainer">
        ...
        <font style="font-size:44px;">Horizontal Bar Chart</font>
        </h1>
     ...
     <div class="frame">
     <img src="../images/Section_SC/HighRes/SC_HBar_H.jpg" alt="" width="1200px" height="690px">
     </div>

     <div class="frame">
      <div class="tcontainer"style="width:800px">
        <font style="font-size:20px;"><br>
        Here is an example of a Horizontal Bar Chart in Row 64 and how to access it.<br><br><br><br><br>
        ...
        <font style="font-size:20px;">
            <br><br>
            Click on Horizontal Bar.<br>
        </font>
        <img src="./images/Radar.png" alt="" width="255px" height="234px">
        <font style="font-size:20px;">
            <br><br>
            Click Run.<br>
        </font>

<?php session_start();
  ...
  if(isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] == true){
    echo '<script type="text/javascript">window.location = "/Download/Download.php?file_name=Row64_V1_5_Installer.exe"</script>';
    exit;
  }
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <link rel="stylesheet" href="Downloading.css?4904390">
...
?>
    ...
    <div id="ContentLayer">
    <!--#########--><div class="frame"><div class="filler" style="height:100px; background-color:#FFFFFF; width:100%;"></div></div>
    <div class="frame"style=" width:100%;flex-wrap:wrap;">
      <div class="tcontainer"style="background-color:#FFFFFF;color:#000000;width:fit-content;justify-content:flex-start;">
        <div class="frame" style="height:fit-content;background-color:#FFFFFF">
        <div class="C_Parent" style="">
        <h1 style="margin-block-start:0px;margin-block-end:20px;font-size:35px">
          Create Account
          </h1>
                      <div class="C_Center"style="height:fit-content">
                        ...
                        <form id="contactForm" method="POST">
                          ...
                          <input type="submit" name="submit" value="Download" style="height: fit-content;line-height: unset;font-size: 30px;width: 200px;margin-left: 50px;background-color:#3689EC;">
        ...
        <div style="width:fit-content"><a href="/Downloads" class="abo">Looking for Mac or Linux?</a></div>
      </div>
      <div style="width:50px;"></div>
      <div class="tcontainer"style="width:fit-content;justify-content:flex-start;background-color:#E2EEF7;border-radius: 10px;box-shadow: 5px 5px 10px grey;margin-bottom: 15px;">
        <img src="./images/animatedLine.gif" alt=""width="542" height="291" style="margin: 10px;margin-bottom: 0px;">
        <div style="height:10px"></div>
        <div style="width:fit-content;color:#000000;margin-left:10px;">Version 1.5 - <a href="https://www.youtube.com/watch?v=mkmC1rsEXmA&list=PLzKFraMMbVENkYMb1P2WoYPlH7QE5dl_k" class="abo" target="_blank" rel="noopener noreferrer"> What's new </a> / <a href="https://forum.row64.com/c/install/11" class="abo" target="_blank" rel="noopener noreferrer"> Install help </a> / <a href="/Downloads" class="abo"> Prior Versions</a></div>
        <div style="height:10px"></div>
      </div>
    </div>

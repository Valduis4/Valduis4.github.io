<?php session_start();
  ...
  if(isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] == true){
    $_SESSION["ReURL"] = "/Whitepaper/Doc.php";
    echo '<script type="text/javascript">window.location = "/Whitepaper/Download.php?file_name=RecipeUniverse_Doc.pdf"</script>';
    exit;
  }
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>Row64 - Documentation</title>
    <link rel="shortcut icon" href="./images/favicon.ico">
    <link rel="canonical" href="https://row64.com/Whitepaper/Doc.php" />
  </head>
...
?>
    ...
    <div class="frame"style=" width:100%;flex-wrap:wrap;">
      <div class="tcontainer"style="background-color:#FFFFFF;color:#000000;width:fit-content;justify-content:flex-start;max-width: 475px;">
      ...
      <div class="tcontainer"style="width:fit-content;justify-content:flex-start;background-color:#E2EEF7;border-radius: 10px;box-shadow: 5px 5px 10px grey;margin-bottom: 15px;">
        <img src="./images/Chart.png" alt=""width="542" height="291" style="margin: 10px;margin-bottom: 0px;">
        <div style="height:10px"></div>
        <div style="height:10px"></div>
      </div>
    </div>

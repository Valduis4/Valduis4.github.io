...
<html>
  <head>
    ...
    <title>Row64 - Contact Us</title>
    <link rel="shortcut icon" href="/images/favicon.ico">
    <link rel="canonical" href="https://row64.com/ContactUs/" />
  </head>
...
<script type="text/javascript"> _linkedin_partner_id = "3680242"; window._linkedin_data_partner_ids = window._linkedin_data_partner_ids || []; window._linkedin_data_partner_ids.push(_linkedin_partner_id); </script><script type="text/javascript"> (function(l) { if (!l){window.lintrk = function(a,b){window.lintrk.q.push([a,b])}; window.lintrk.q=[]} var s = document.getElementsByTagName("script")[0]; var b = document.createElement("script"); b.type = "text/javascript";b.async = true; b.src = "https://snap.licdn.com/li.lms-analytics/insight.min.js"; s.parentNode.insertBefore(b, s);})(window.lintrk); </script> <noscript> <img height="1" width="1" style="display:none;" alt="" src="https://px.ads.linkedin.com/collect/?pid=3680242&fmt=gif" /> </noscript>
  <body>
    ...
    <div id="ContentLayer">
        ...
        <div class="C_Parent" > 
            <div class="C_Outer" >
                <div class="C_LabelBox" >
                    <div class="titleT">
                      <!-- We'd love to help you improve the peformance
                      of your data work. -->

                      We'd love to help you improve the speed & scale
                      of your data work.
                    </div>
                    ...
                    <div class="mainT">
                      If you have any questions about your account, please contact support@row64.com.
                    </div>
                    <div class="C_Spacer" style="height:60px"></div>
                    <div class="titleT">
                      Other Communication
                    ...
                    <div class="C_Spacer" style="height:10px"></div>
                    <div class="mainT">
                      For partnership, media, and career inquiries, please reach out to info@row64.com.
                    </div>
                </div>
                ...
                <div class="C_FormBox">
                    <div class="C_Edge"></div>
                      <div class="C_Center">
                        ...
                        <form action="/ContactUsSubmit/" id="contactForm" method="POST">
                          ...
                          <label for="lname">Additional Information:</label><br>
                          <div class="C_Spacer" style="height:8px"></div>
                          
                          <textarea class="form-control" rows="4" cols="50" id="feedback" name="feedback" maxlength="1000"></textarea>
        ...
        <div class="CM_Parent">
            <div class="CM_Outer">
                <div class="C_TopLabelBox" >
                    ...
                    <div class="C_Spacer" style="height:70px"></div>
      ...
      <!--#########--><div class="frame" style="height:50px;background-color:#F7F8F9"></div>
  <?php
      // this is just here for testing post values
      // require('connect.php');
      error_reporting(-1);
      $country = $_POST['country'];
      // print "# 0000000 ###################" . $country . "\n";
      ...
      if(isset($_POST["submit"])){
        print "submit submit submit submit\n\n";

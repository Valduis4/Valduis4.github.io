...
function clickrow(i) {
    ...
    if (div.classList.contains('target')) {
        document.getElementById(i).className = "anchor line";
        uids.remove(i);
    } else {
        document.getElementById(i).className = "anchor line target";
        uids[i] = i;
    }
    document.getElementById('uids').setAttribute('value', uids);
}
const uids1 = [];
function clickrow2(i) {
    const div = document.getElementById(i);
    if (div.classList.contains('target')) {
        document.getElementById(i).className = "anchor line";
        uids1.remove(i);
    ...
    document.getElementById('uids1').setAttribute('value', uids1);
}
...
<html>
  <head>
    ...
    <title>Row64 - Privacy Policy</title>
    <link rel="shortcut icon" href="/images/favicon.ico">
    <link rel="canonical" href="https://row64.com/Privacy_Policy/" />
  </head>
  ...
  <body>
    ...
    <div class="frame">
      <div class="tcontainer">
        <h1>
        <font style="font-size:44px;">Privacy Policy</font>
        </h1>
      </div>
    </div>
    ...
    <div class="frame" stlye="height:fit-content;justify-content:center;overflow: scroll; -webkit-overflow-scrolling: touch;" >
    <iframe id="myiframe" class="desktop-pdf" src="https://drive.google.com/viewerng/viewer?embedded=true&url=https://row64.com/Privacy_Policy/Row64%20Privacy%20Policy%20(09.21.21).pdf#toolbar=0">
    </iframe>
    <iframe class="mobile-pdf" scrolling="auto" src="https://drive.google.com/viewerng/viewer?embedded=true&url=https://row64.com/Privacy_Policy/Row64%20Privacy%20Policy%20(09.21.21).pdf" width="100%" height="90%" type='application/pdf' title="Title">
    </iframe>
    </div>
